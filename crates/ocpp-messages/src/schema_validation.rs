...
static SCHEMA_TEXTS_V201: &[(&str, &str)] = &[
    ...
    (
        ...
        include_str!("../schemas/v201/PublishFirmwareStatusNotification.json"),
    ),
    (
    ...
    (
        ...
        include_str!("../schemas/v201/ClearVariableMonitoring.json"),
    ),
    (
        "ClearVariableMonitoringResponse",
        include_str!("../schemas/v201/ClearVariableMonitoringResponse.json"),
    ),
    (
    ...
    (
        "SetDisplayMessage",
        include_str!("../schemas/v201/SetDisplayMessage.json"),
    ),
    (
    ...
    ("GetLog", include_str!("../schemas/v201/GetLog.json")),
    (
        "GetLogResponse",
    ...
    (
        ...
        include_str!("../schemas/v201/NotifyDisplayMessages.json"),
    ),
    (
    ...
    (
        ...
        include_str!("../schemas/v201/NotifyCustomerInformation.json"),
    ),
    (
        "NotifyCustomerInformationResponse",
        include_str!("../schemas/v201/NotifyCustomerInformationResponse.json"),
    ),
    (
        "CustomerInformation",
    ...
    (
        ...
        include_str!("../schemas/v201/NotifyEVChargingSchedule.json"),
    ),
    (
