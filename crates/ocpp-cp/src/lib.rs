...
use ocpp_types::v201::{
    ...
    ChargingProfilePurposeEnumType, ConnectorStatusEnumType, GenericDeviceModelStatusEnumType,
    GetVariableResultType, MessageTriggerEnumType, OperationalStatusEnumType,
